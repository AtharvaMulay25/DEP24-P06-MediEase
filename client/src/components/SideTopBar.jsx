...
export function SideTopBar() {
  ...
  return (
      ...
      <div className="flex  overflow-hidden">
        <div
          className="transition-width duration-300 h-screen"
          style={{
          ...
          >
              ...
              {!(isCollapsed & !isHovered) && (
                <AccordionBody className="py-1">
                  <List className="p-0" style={{ color: "#f1ffea" }}>
                    ...
                    <ListItem className="ml-9">Medicine List</ListItem>
                  </List>
                </AccordionBody>
              )}
            </Accordion>
            ...
            >
              ...
              {!(isCollapsed & !isHovered) && (
                <AccordionBody className="py-1">
                  <List className="p-0" style={{ color: "#f1ffea" }}>
                    <ListItem className="ml-9">Add Supplier</ListItem>
                    <ListItem className="ml-9">Supplier List</ListItem>
                  </List>
                </AccordionBody>
              )}
            </Accordion>
